...
const VisitorButton = (params) => {
    ...
    return (
        <div
            ...
            <Button className="visitor-button d-flex gap-2 justify-content-start">
                <i class="bi bi-person-fill"></i>
                <span className="visitor-name">CPL, Tommy Goodman</span>
                <i class="bi bi-signpost-split-fill"></i>
                <span className="visitor-destination">Instrument Systems</span>
